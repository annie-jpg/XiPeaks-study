...
%% B - sleep staging
clc;clear;close all;
bp = BarPlot('ylabel', 'LDA performance(%)');

cmap = parula(8);

g = bp.addGroup('Wake-N2');
b1 = g.addBar('XiPi', 83.47, 'confInt', [79.52 87.42], 'FaceColor', cmap(5, :)); 
b2 = g.addBar('FOOOF', 79.73, 'confInt', [75.54 83.92], 'FaceColor', cmap(7, :)); 

g = bp.addGroup('Wake-REM');
b3 = g.addBar('XiPi', 98.43, 'confInt', [97.82 99.04], 'FaceColor', cmap(5, :));
b4 = g.addBar('FOOOF', 96.33, 'confInt', [94.94 97.72], 'FaceColor', cmap(7, :));

g = bp.addGroup('N2-REM');
b5 = g.addBar('XiPi', 84.46, 'confInt', [80.31 88.61], 'FaceColor', cmap(5, :));
